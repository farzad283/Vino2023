<section x-data="{ open: false }" class="flex flex-col lg:flex-row">
    <button @click="open = !open" class="fixed top-35 right-4 bg-gold mt-1 text-white p-2 rounded-full lg:hidden"> 
        <div title="Panneau de statistiques">
    ...
    <div class="fixed top-25 left-0 w-64 h-full bg-slate-300 text-white   
        ...
        <ul class="space-y-2 text-red ">
            <li class="py-2 border-b border-gold"> 
                <a title="Statistiques des celliers" href="#cellars-statistics" wire:click="$set('page', 'cellars-statistics')" class="block px-4 py-2 rounded hover:bg-zinc-400">
                    <div class="flex flex-row gap-3">
                        <svg class="h-5 w-5" fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512">
                        ...
                        <h3 class="text-dark-red">Statistiques des celliers</h3>
                    </div>
                </a>
            </li>
            <li class="py-2 border-b border-gold">
                <a title="Statistiques d'utilisateurs" href="#users-statistics" wire:click="$set('page', 'users-statistics')" class="block px-4 py-2 rounded hover:bg-zinc-400">
                    <div class="flex flex-row gap-3" >
                        ...
                        <h3 class="text-dark-red">Statistiques d'utilisateurs</h3>
                    </div>
                </a>
            </li>
            <li class="py-2 border-b border-gold">
                <a title="Statistiques des bouteilles" href="#bottles-statistics" wire:click="$set('page', 'bottles-statistics')" class="block px-4 py-2 rounded hover:bg-zinc-400">
                    <div class="flex flex-row gap-3">
                        ...
                        <h3 class="text-dark-red">Statistiques des bouteilles</h3>
                    </div>
                </a>
            </li>
            <li class="py-2">
                <a title="Mise à jour SAQ"  href="#update" wire:click="$set('page', 'update-saq')" 
                 class="block px-4 py-2 rounded hover:bg-zinc-400">
                    <div class="flex flex-row gap-3">
                        <svg class="h-5 w-5 " fill="currentColor" viewBox="0 0 48 48" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <h3 class="text-dark-red">Mise à jour SAQ</h3>
                    </div>
                </a>
            </li>
