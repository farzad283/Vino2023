<div class="fixed top-10 left-7 flex justify-center items-center h-screen  lg:right-6 ">
    <div class="bg-dark-red bg-opacity-20 p-6 rounded-lg shadow-md w-80 lg:w-96">
        ...
        <form class="flex flex-col" wire:submit.prevent="handleSearch">
            ...
            <label for="priceMin" class="mb-2 text-red">Prix minimum:</label>
            ...
            <label for="priceMax" class="mb-2 text-red">Prix maximal:</label>
