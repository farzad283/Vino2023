<section class="container mx-auto p-4 text-center ">
    <div class="text-2xl font-bold mb-8 mt-6">Statistique du contenu des celliers</div>
        ...
        <table class="min-w-full bg-white ">
            <thead class="text-gold text-center  bg-slate-200">
                <tr>
                    ...
                    <th title="Nom de cellier" class="py-2">
                        <svg class="h-5 w-5 inline-block" fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512">
                    ...
                    <th title="Quantité de bouteilles" class="py-2 ">
                        <svg class="h-5 w-5 inline-block" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    ...
                    <th title="Le prix total des bouteilles" class="py-2 ">
                        $
                    </th>
