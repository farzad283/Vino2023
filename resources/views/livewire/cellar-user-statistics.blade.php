        ...
        <table class="min-w-full bg-white ">
            <thead class="text-gold text-center  bg-slate-200">
                <tr>
                    ...
                    <th class="py-2">
                        <svg class="h-5 w-5 inline-block" fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
                    ...
                    <th class="py-2 ">
                        ...
                        <svg class="h-5 w-5 inline-block" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512"><!--! Font Awesome Pro 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license (Commercial License) Copyright 2023 Fonticons, Inc. -->
            ...
            <tbody>
                @foreach($cellars_user_statistics as $index=>$cellar)
                <tr class=" border-t border-gray-200 even:bg-slate-200 odd:bg-white text-center  items-cente">
                    ...
                    <td class="py-2 text-center  items-center">{{ $cellar->name}}</td>
                    <td class="py-2 text-center  items-center">{{ $cellar->bottle_count }}</td>
                    <td class="py-2 text-center  items-center">{{ $cellar->bottles_consumed }}</td>
                    <td class="py-2 text-center  items-center">{{ $cellar->total_price }}</td>
