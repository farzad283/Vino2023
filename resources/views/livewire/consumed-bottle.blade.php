    ...
    <div class="w-full max-w-sm p-4 bg-white shadow-lg rounded-lg flex flex-col items-center">
        ...
        <form wire:submit.prevent="store">
            ...
            <div class="mb-4">
                ...
                <textarea name="" id="" cols="30" rows="10"  wire:model="note" id="note" aria-placeholder="note"
                 placeholder="écrivez votre commentaire" class="w-full px-3 py-2 mt-1 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-500"></textarea>
