    ...
    <div class="mt-6">
        <div class="max-w-1200px">
            ...
            <div class="flex flex-col md:flex-row justify-between">
                ...
                <a class="max-w-80 relative bottom-3 -mt-4 transform transition-transform duration-300 hover:scale-125 hover:brightness-80" href="{{ route('single-bottle', ['bottle_id' => $bottle->id]) }}" >
