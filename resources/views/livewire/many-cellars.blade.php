<div class="p-4">
    ...
    <div class="flex items-center justify-between  mb-6 mt-2 ml-1">
        ...
        <a href="{{ route('user-cellars-statistics') }}" class="">

            <div title="Statistiques vos celliers">
        ...
        <div class="flex items-center space-x-1 mr-24 lg:mr-auto ">
            <a href="{{ route('add-cellar') }}" class="bg-gold  text-white px-4 py-1 rounded hover:bg-dark-red  block w-32 ml-6 mx-auto ">@livewire('button', ['label' => 'Créer cellier'])
            </a>
        </div>
    ...
    <h2 class="text-2xl font-bold mb-4 text-center lg:text-2xl ">Vos Celliers</h2>
        ...
        <div class="flex flex-col gap-4 ">
            ...
            <div class="border border-red rounded-lg p-2 text-red hover:bg-white hover:text-red shadow mx-auto flex justify-between items-center w-5/6">
                ...
                <div class="flex items-center space-x-2">
                    ...
                    <div  title="Modifier nom de cellier ">
