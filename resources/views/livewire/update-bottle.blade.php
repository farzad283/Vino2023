   ...
   <div class="bg-dark-red bg-opacity-20 p-6 rounded-lg shadow-md w-80 lg:w-96">
      ...
      <form wire:submit.prevent="store">
         ...
         <div class="mb-4">
            ...
            <select wire:model="new_cellar_id" id="cellar" class="w-full px-3 py-2 mt-1 border border-gray-300 rounded-md focus:outline-none focus:ring focus:ring-blue-500">
      ...
      <a href="{{ route('singleCellar', ['cellar_id' => $cellar_id ]) }}" class="py-2 text-red">
