    ...
    <div class="overflow-x-auto">
        <table class="min-w-full bg-white table-auto w-full rounded-lg overflow-hidden ">
            <thead class="text-gold text-center bg-slate-200">
                <tr>
                    <th title="ID de l'utilisateur" class="px-2 md:px-4 py-2 ">
                    ...
                    <th title="Nom d'utilisateur" class="px-2 md:px-4 py-2">
                        <svg class="h-5 w-5 inline-block" fill="currentColor"  xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><path d="M224 256A128 128 0 1 0 224 0a128 128 0 1 0 0 256zm-45.7 48C79.8 304 0 383.8 0 482.3C0 498.7 13.3 512 29.7 512H418.3c16.4 0 29.7-13.3 29.7-29.7C448 383.8 368.2 304 269.7 304H178.3z"/></svg>
                    </th>
                    <th title="Nombre de cellier" class="px-2 md:px-4 py-2">
                    ...
                    <th title="Valeur totale des bouteilles" class="px-4 py-2">
